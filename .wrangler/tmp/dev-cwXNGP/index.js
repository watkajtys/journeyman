...
// .wrangler/tmp/bundle-CtUjwO/checked-fetch.js
  ...
  async fetch(request, env, ctx) {
    ...
    try {
      ...
      if (pathname === "/editor" || pathname === "/editor/") {
        const newUrl = new URL(request.url);
        newUrl.pathname = "/editor/index.html";
        return env.ASSETS.fetch(new Request(newUrl, request));
      }
...
// .wrangler/tmp/bundle-CtUjwO/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-CtUjwO/middleware-loader.entry.ts
